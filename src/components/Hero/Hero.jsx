      ...
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          Bachelor of Science in Computer Science from Weber State University. With 3 years of experience using Python and
           Pandas, automating data tasks for a Charter School District in Utah. {/*Aspiring Software Developer with strong foundations in data automation, scripting, and full-stack development. Known
